 ...
 * [HotelREST/consulta_libres]<br>
 * USAGE:
 * <pre>
 *        RESTConsultaLibresHotel client = new RESTConsultaLibresHotel();
 ...
 * @author Santi
 */
public class RESTConsultaLibresHotel {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/HotelREST/webresources/";

    public RESTConsultaLibresHotel() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("HotelREST/consulta_libres");
    }
