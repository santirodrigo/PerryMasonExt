                        ...
                        <form>
                            <table class="default">
                                <tr>
                                    ...
                                    <th>Fecha</th>
                                    <td>
                                        <input required placeholder="aaaammdd" name="fechaBuscar" maxlength="8" id="fecha"/>
                                    </td>
                                    <th>Web service</th>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="6" style="text-align: center">
                                        <input type="submit" onClick="getnumHab();return false;" value="Buscar habitaciones hotel" />
                                    </td>
                                </tr>
                            </table>
                        </form>
